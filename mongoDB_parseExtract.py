...
source_db = source_client['URLDATA2']
source_collection = source_db['url2']

destination_client = MongoClient('localhost', 27017)
destination_db = destination_client['URLDATA2']
destination_collection = destination_db['url2_extracted']
