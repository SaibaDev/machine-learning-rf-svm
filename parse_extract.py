#PARSING AND FEATURE EXTRACTION OF URLS

#I-PARSE AT I-EXTRACT ANG FEATURES NG DATASET BEFORE MODEL TRAINING
...
#Feature extraction na fucntion
...
#create ng list - para sa features ng bawat url
features_list = []
...
#field names para sa OUTPUT na CSV
...
#write mga EXTRACTED na features sa CSV
